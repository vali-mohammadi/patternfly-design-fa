...
| `content/olguha/login.md` | صفحهٔ ورود | `pattern-library/application-framework/login-page/` | ادغام‌وپالایش‌شده — ساختار کارت مشترک با ورود چندمرحله‌ای و ورود یکپارچه، برای جلوگیری از تکرار سه‌باره، اینجا مرکزی نگه‌داشته شد. **بازساخت در گشت پایانی نقشهٔ راه:** «ورود با تلفن و OTP» به‌عنوان الگویی هم‌سطح با نام کاربری/گذرواژه اضافه شد، نه فقط یادداشت پابرگی — با راهنمای انتخاب بر پایهٔ مخاطب واقعی (سازمانی/SSO در برابر مصرفی ایرانی) |
